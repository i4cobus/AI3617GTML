...
>python experiment.py --seed [n]

There are 4 agent settings in the experiment:not moving, random, baseline and our rule-based agent.

We haven't set args for different combination of agents, so you may need to remove some comments to run certain experiment.